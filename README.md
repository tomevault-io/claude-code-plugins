...
AI instruction files in `CLAUDE.md` format, packaged as a custom Claude Code marketplace. Each is graded against the public Tome Standard and kept current as the models change by [TomeVault](https://tomevault.io).
