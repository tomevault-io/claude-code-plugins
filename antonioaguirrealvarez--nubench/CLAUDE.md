...
```
Read and follow the instructions in .claude/skills/nubench/SKILL.md
```
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/antonioaguirrealvarez) — claim your Tome and manage your conversions.
