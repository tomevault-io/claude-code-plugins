...
```
Read and follow the instructions in .claude/skills/keys-latest-glm-5-2-quantrio-int4-int8-mixed-abliterated-dflash/SKILL.md
```
...
<!-- tomevault:4.0:claude_md:2026-07-19 -->
