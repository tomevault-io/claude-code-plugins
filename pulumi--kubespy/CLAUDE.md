...
```
Read and follow the instructions in .claude/skills/kubespy/SKILL.md
```
...
---
> Source: [pulumi/kubespy](https://github.com/pulumi/kubespy) — distributed by [TomeVault](https://tomevault.io).
