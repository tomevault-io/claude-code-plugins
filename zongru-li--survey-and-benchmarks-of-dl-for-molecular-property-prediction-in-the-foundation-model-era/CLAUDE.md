...
```
Read and follow the instructions in .claude/skills/survey-and-benchmarks-of-dl-for-molecular-property-prediction-in/SKILL.md
```
...
<!-- tomevault:4.0:claude_md:2026-05-12 -->
